...
FILES=src/main.cc src/filter/filters.cc src/detection/shape.cc src/detection/circle.cc src/ransac/ransac.cc src/detection/typePanneau.cc src/audio/audio.cc src/surf/surf.cc
OBJ=$(FILES:.cc=.o)
TARGET=pinanagne
